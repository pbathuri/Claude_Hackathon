...
// Demo hint: visible license numbers that work
const DEMO_LICENSES = [
  { label: "Dr. Amara Osei (Tier 1–4)", value: "WHO-KE-2019-04821" },
  { label: "Dr. Priya Chakraborty (Tier 3–4)", value: "WHO-BD-2021-11203" },
];
