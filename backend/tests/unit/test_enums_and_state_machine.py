...
class TestCaseStatusTransitions(unittest.TestCase):
    def test_valid_transitions(self):
        self.assertTrue(validate_transition(CaseStatus.CREATED, CaseStatus.ACTIVE_INTAKE))
        self.assertTrue(validate_transition(CaseStatus.ACTIVE_INTAKE, CaseStatus.INTAKE_COMPLETE))
    ...
    def test_invalid_transitions(self):
        ...
        self.assertFalse(validate_transition(CaseStatus.CLOSED, CaseStatus.ACTIVE_INTAKE))
    ...
    def test_escalation_from_any_active_state(self):
        escalatable = [
            CaseStatus.ACTIVE_INTAKE, CaseStatus.PENDING_REVIEW,
            CaseStatus.ASSIGNED, CaseStatus.IN_REVIEW,
            CaseStatus.FOLLOWUP_PENDING, CaseStatus.FOLLOWUP_REPLIED,
        ]
